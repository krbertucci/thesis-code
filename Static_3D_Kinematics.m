tbl_mvmnt_file_name='S01_001_3d';
...
figure('Name',"Segment Angles vs. time for " + tbl_mvmnt_file_name,'NumberTitle','off')
   subplot(3,3,1)
       plot(tpf,rad2deg(tbl_mvmnt.foot_gamma))
       title('Foot Gamma')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
   subplot(3,3,2)   
       plot(tpf,rad2deg(tbl_mvmnt.foot_beta))
       title('Foot Beta')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
   subplot(3,3,3)
       plot(tpf,rad2deg(tbl_mvmnt.foot_alpha))
       title('Foot Alpha')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
       
   subplot(3,3,4)
       plot(tpf,rad2deg(tbl_mvmnt.shank_gamma))
       title('Shank Gamma')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
   subplot(3,3,5)   
       plot(tpf,rad2deg(tbl_mvmnt.shank_beta))
       title('Shank Beta')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
   subplot(3,3,6)
       plot(tpf,rad2deg(tbl_mvmnt.shank_alpha))
       title('Shank Alpha')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')       
  
   subplot(3,3,7)
       plot(tpf,rad2deg(tbl_mvmnt.thigh_gamma))
       title('Thigh Gamma')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
   subplot(3,3,8)   
       plot(tpf,rad2deg(tbl_mvmnt.thigh_beta))
       title('Thigh Beta')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
   subplot(3,3,9)
       plot(tpf,rad2deg(tbl_mvmnt.thigh_alpha))
       title('Thigh Alpha')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
saveas(gcf, "foot_shank_thigh_seg_angles_" + tbl_mvmnt_file_name + ".png")
...
figure('Name',"Foot Relative to Shank Intersegment Angles vs. time for " + tbl_mvmnt_file_name,'NumberTitle','off')
   subplot(3,1,1)
       plot(tpf,rad2deg(tbl_mvmnt.foot_shank_gamma))
       title('Intersegmental Rotation (Gamma)')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
   subplot(3,1,2)   
       plot(tpf,rad2deg(tbl_mvmnt.foot_shank_beta))
       title('Intersegmental Inversion/Eversion (Beta)')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
   subplot(3,1,3)
       plot(tpf,rad2deg(tbl_mvmnt.foot_shank_alpha))
...
figure('Name',"Shank Relative to Thigh Intersegment Angles vs. time for " + tbl_mvmnt_file_name,'NumberTitle','off')
   subplot(3,1,1)
       plot(tpf,rad2deg(tbl_mvmnt.thigh_shank_gamma))
       title('Intersegmental Rotation (Gamma)')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
   subplot(3,1,2)   
       plot(tpf,rad2deg(tbl_mvmnt.thigh_shank_beta))
       title('Intersegmental Varus/Valgus (Beta)')
       xlabel('time (s)')
       ylabel('Euler Angle (deg)')
   subplot(3,1,3)
       plot(tpf,rad2deg(tbl_mvmnt.thigh_shank_alpha))
...
figure('Name',"Tibiofemoral angles with differing Euler Conventions for " + tbl_mvmnt_file_name ,'NumberTitle','off')
   subplot(3,1,1)
       plot(tpf,rad2deg(tbl_mvmnt.thigh_shank_gamma))
       hold on
       plot(tpf,rad2deg(tbl_mvmnt.thigh_shank_gamma_Rxyz))
       hold off
       legend('Rzyx','Rxyz')
       title('Intersegmental Rotation (Gamma)')
       xlabel('time (s)')
   ...
   subplot(3,1,2)   
       plot(tpf,rad2deg(tbl_mvmnt.thigh_shank_beta))
       hold on
       plot(tpf,rad2deg(tbl_mvmnt.thigh_shank_beta_Rxyz))
       hold off
       legend('Rzyx','Rxyz')
       title('Intersegmental Varus/Valgus (Beta)')
       xlabel('time (s)')
   ...
   subplot(3,1,3)
       plot(tpf,rad2deg(tbl_mvmnt.thigh_shank_alpha))
       hold on
       plot(tpf,rad2deg(tbl_mvmnt.thigh_shank_alpha_Rxyz))
       hold off
       legend('Rzyx','Rxyz')
       title('Intersegmental Flexion/Extension (Alpha)')
       xlabel('time (s)')
